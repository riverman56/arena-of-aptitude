...
local function RgbToLuv13(color: Color3)
...
local function lerpCIELUV(baseColor: Color3, goalColor: Color3, alpha: number)
    local l0, u0, v0 = RgbToLuv13(baseColor)
    local l1, u1, v1 = RgbToLuv13(goalColor)
